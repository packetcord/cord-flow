...
static cord_retval_t CordFlowPoint_rx_(CordFlowPoint const * const self, void *buffer)
{
    (void)self;
    (void)buffer;
...
static cord_retval_t CordFlowPoint_tx_(CordFlowPoint const * const self, void *buffer)
{
    (void)self;
    (void)buffer;
