...
static cord_retval_t CordFlowPoint_rx_(CordFlowPoint * const self, uint16_t queue_id, void *buffer, size_t len, ssize_t *rxed)
{
...
static cord_retval_t CordFlowPoint_tx_(CordFlowPoint * const self, uint16_t queue_id, void *buffer, size_t len, ssize_t *txed)
{
#ifdef CORD_FLOW_POINT_LOG
...
static cord_retval_t CordFlowPoint_attach_xBPF_(CordFlowPoint * const self, void *filter, void *params)
{
#ifdef CORD_FLOW_POINT_LOG
...
void CordFlowPoint_ctor(CordFlowPoint * const self, uint8_t id)
{
    ...
    static const CordFlowPointVtbl vtbl = {
        ...
        .attach_xBPF = CordFlowPoint_attach_xBPF_,
        .cleanup = CordFlowPoint_dtor,
    };
