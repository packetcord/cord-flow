...
#define CORD_CREATE_L4_SCTP_FLOW_POINT_ON_HEAP(id, rx_buffer_size, ipv4_src_addr, ipv4_dst_addr, src_port, dst_port) \
    (CordFlowPoint *) NEW_ON_HEAP(CordL4SctpFlowPoint, id, rx_buffer_size, ipv4_src_addr, ipv4_dst_addr, src_port, dst_port)

#define CORD_CREATE_L4_SCTP_FLOW_POINT_ON_STACK(id, rx_buffer_size, ipv4_src_addr, ipv4_dst_addr, src_port, dst_port)\
    (CordFlowPoint *) &NEW_ON_STACK(CordL4SctpFlowPoint, id, rx_buffer_size, ipv4_src_addr, ipv4_dst_addr, src_port, dst_port)
